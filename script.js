...
// --------------------- CONFIGURACIÓN ROLES ---------------------
const rolesConfig = {
    aldeanos: ["Aldeano", "Lobo", "Vidente", "Protector", "Bruja", "Cazador"],
    ambiguos: ["Lobo Infectador", "La niña", "Cúpido", "El tonto del pueblo", "Anciano", "Cabeza de turco", "Niño salvaje", "Perro Lobo"]
};
...
const rolesDescripcion = {
    ...
    "Niño salvaje": "Eliges un modelo. Si el modelo muere, te conviertes en Lobo.",
...
function initRolesCounters() {
    ...
    [...rolesConfig.aldeanos, ...rolesConfig.ambiguos].forEach(rol => {
...
verReglasBtn.addEventListener('click', () => { if (modalPDF) modalPDF.style.display = 'block'; });
if (verReglasNarradorBtn) {
    verReglasNarradorBtn.addEventListener('click', () => { if (modalPDF) modalPDF.style.display = 'block'; });
}
