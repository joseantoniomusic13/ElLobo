...
if (verReglasNarradorBtn) {
    verReglasNarradorBtn.addEventListener('click', () => { modalPDF.style.display = 'block'; });
}
...
// Reiniciar Rápido (Mismos jugadores, nuevos roles)
reiniciarRapidoBtn.addEventListener('click', () => {
    ...
    setTimeout(() => {
        // Ocultar animación y asignar roles
